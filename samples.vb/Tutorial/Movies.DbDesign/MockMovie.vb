...
Public Class MockMovie
    ...
    Private Shared Function GetMovies() As DataSet(Of Movie)
        Dim result As DataSet(Of Movie) = DataSet(Of Movie).Create().AddRows(3)
        ...
        x.Title(1) = "Ghostbusters 2"
        x.Title(2) = "Rio Bravo"
        x.ReleaseDate(0) = Convert.ToDateTime("1989-02-12T00:00:00")
        x.ReleaseDate(1) = Convert.ToDateTime("1986-02-23T00:00:00")
        x.ReleaseDate(2) = Convert.ToDateTime("1959-04-15T00:00:00")
