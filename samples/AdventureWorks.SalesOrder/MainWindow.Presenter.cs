    ...
    partial class MainWindow
    {
        ...
        private class Presenter : DataPresenter<SalesOrder>, ColumnHeader.ISortService
        {
            ...
            protected override void BuildTemplate(TemplateBuilder builder)
            {
                ...
                .AddBinding(0, 0, this.AsCheckBoxToSelectAll().WithStyle(Styles.CheckBox))
                ...
                .AddBinding(0, 1, _.AsCheckBoxToSelectRow().WithStyle(Styles.CheckBox))
                .AddBinding(1, 1, _.SalesOrderID.AsTextBlockOfHyperlink(ApplicationCommands.Open).WithStyle(Styles.LeftAlignedTextBlock))
                .AddBinding(2, 1, _.SalesOrderNumber.AsTextBlock().WithStyle(Styles.LeftAlignedTextBlock))
                .AddBinding(3, 1, _.DueDate.AsTextBlock("{0:d}").WithStyle(Styles.RightAlignedTextBlock))
                .AddBinding(4, 1, _.ShipDate.AsTextBlock("{0:d}").WithStyle(Styles.RightAlignedTextBlock))
                .AddBinding(5, 1, _.Status.AsTextBlock().WithStyle(Styles.LeftAlignedTextBlock))
                .AddBinding(6, 1, _.PurchaseOrderNumber.AsTextBlock().WithStyle(Styles.LeftAlignedTextBlock))
                .AddBinding(7, 1, _.SubTotal.AsTextBlock("{0:C}").WithStyle(Styles.RightAlignedTextBlock))
                .AddBinding(8, 1, _.TaxAmt.AsTextBlock("{0:C}").WithStyle(Styles.RightAlignedTextBlock))
                .AddBinding(9, 1, _.TotalDue.AsTextBlock("{0:C}").WithStyle(Styles.RightAlignedTextBlock).AddBehavior(new TotalDueConditionalFormat(_.TotalDue)))
