    ...
    partial class MainWindow
    {
        ...
        private class Presenter : DataPresenter<SalesOrder>, ColumnHeader.ISortService
        {
            ...
            protected override void BuildTemplate(TemplateBuilder builder)
            {
                ...
                .AddBinding(0, 0, this.AsSelectionCheckBox().WithStyle(Styles.CheckBox))
                ...
                .AddBinding(0, 1, _.AsSelectionCheckBox().WithStyle(Styles.CheckBox))
                .AddBinding(1, 1, _.SalesOrderID.AsHyperlinkTextBlock(ApplicationCommands.Open).WithStyle(Styles.LeftAlignedTextBlock))
