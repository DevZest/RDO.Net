// Code from: https://github.com/Wintellect/Wintellect.Analyzers/blob/master/Source/Wintellect.Analyzers/Wintellect.Analyzers/Extensions/NodeExtensions.cs
...
static class NodeExtensions
{
    ...
    /// </summary>
    private static readonly Regex nonUserAttributeRegex = new Regex(@".*(GeneratedCode|DebuggerNonUserCode)(Attribute)?", RegexOptions.IgnorePatternWhitespace);
    ...
    {
        return null != node.FirstAncestorOfType(typeof(ForEachStatementSyntax), typeof(ForStatementSyntax), typeof(WhileStatementSyntax), typeof(DoStatementSyntax));
    }
    ...
    public static Boolean IsGeneratedOrNonUserCode(this SyntaxNode node)
    {
        ...
        TypeDeclarationSyntax currType = (TypeDeclarationSyntax)(node.FirstAncestorOrSelfOfType(typeof(ClassDeclarationSyntax), typeof(StructDeclarationSyntax)));
        while (currType != null)
        {
            if (currType.AttributeLists.HasIgnorableAttributes())
                return true;
            currType = (TypeDeclarationSyntax)(currType.FirstAncestorOfType(typeof(ClassDeclarationSyntax), typeof(StructDeclarationSyntax)));
        }
