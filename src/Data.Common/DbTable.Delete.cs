...
namespace DevZest.Data
{
    partial class DbTable<T>
    {
            ...
            where TSource : Model, new()
        {
            ...
            return Delete(DbSession.CreateDbSet(dataSet), keyMappingsBuilder);
        }
            ...
            where TSource : Model, new()
        {
            ...
            return await DeleteAsync(await DbSession.CreateDbSetAsync(dataSet, cancellationToken), keyMappingsBuilder, cancellationToken);
        }
