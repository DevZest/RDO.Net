...
namespace DevZest.Data.Views
{
    ...
    {
        public static readonly RoutedUICommand SortEditCommand = new RoutedUICommand(UIText.ColumnHeader_SortEditCommandText, nameof(SortEditCommand), typeof(ColumnHeader));
