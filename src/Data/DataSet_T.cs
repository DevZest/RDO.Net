...
namespace DevZest.Data
{
        ...
        where T : class, IModelReference, new()
    {
        ...
        public static DataSet<T> ParseJson(Action<T> initializer, string json)
        {
            ...
            return (DataSet<T>)(new JsonReader(json).Parse(() => Create(initializer), true));
        }
            ...
            where TChild : Model, new()
        {
            ...
            return dataRow == null ? childModel.DataSet as DataSet<TChild> : dataRow.GetChildDataSet(childModel);
        }
