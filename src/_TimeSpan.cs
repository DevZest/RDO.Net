...
namespace DevZest.Data.MySql
{
    ...
    /// </summary>
    public sealed class _TimeSpan : Column<TimeSpan?>, IColumn<MySqlReader, TimeSpan?>
    {
        ...
        public TimeSpan? this[MySqlReader reader]
        {
            get
            {
        ...
        private TimeSpan? GetValue(MySqlReader reader)
        {
            return reader.GetTimeSpan(Ordinal);
        }

        void IColumn<MySqlReader>.Read(MySqlReader reader, DataRow dataRow)
        {
