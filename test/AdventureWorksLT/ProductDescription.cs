...
namespace DevZest.Samples.AdventureWorksLT
{
    public class ProductDescription : BaseModel<ProductDescription.Key>
    {
        ...
        public static readonly Mounter<_Int32> _ProductDescriptionID = RegisterColumn((ProductDescription x) => x.ProductDescriptionID);
        public static readonly Mounter<_String> _Description = RegisterColumn((ProductDescription x) => x.Description);
