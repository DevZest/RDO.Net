...
{
    [TestClass]
    public class VisualBasicPropertyRegistrationCodeFixTests : CodeFixVerifier
    {
        ...
        {
            return new VisualBasicPropertyRegistrationCodeFixProvider();
        }
...
Class SimpleModel
    ...
    Public Shared ReadOnly _Column1 As Mounter(Of _Int32) = RegisterColumn(Function(x As SimpleModel) x.Column1)
    Private m_Column1 As _Int32
    Public Property Column1 As _Int32
        Get
            Return m_Column1
...
Class SimpleModel
    ...
    Public Shared ReadOnly _Column1 As Mounter(Of _Int32) = RegisterColumn(Function(x As SimpleModel) x.Column1)
    Public Shared ReadOnly _Column2 As Mounter(Of _Int32) = RegisterColumn(Function(x As SimpleModel) x.Column2)
    Private m_Column1 As _Int32
    Public Property Column1 As _Int32
        Get
            Return m_Column1
...
MustInherit Class SimpleModel(Of T As CandidateKey)
    Inherits Model(Of T)
...
MustInherit Class SimpleModel(Of T As CandidateKey)
    ...
    Public Shared ReadOnly _Column1 As Mounter(Of _Int32) = RegisterColumn(Function(x As SimpleModel(Of T)) x.Column1)
    Private m_Column1 As _Int32
    Public Property Column1 As _Int32
        Get
            Return m_Column1
...
Public Class SimpleModelBase(Of T As {ChildModel, New})
    Inherits Model

    Private m_Child As T
...
Public Class SimpleModelBase(Of T As {ChildModel, New})
    ...
    Shared Sub New()
        RegisterChildModel(Function(x As SimpleModelBase(Of T)) x.Child)
    End Sub
...
Public Class ChildModel
    ...
    Public Shared ReadOnly _ParentID As Mounter(Of _Int32) = RegisterColumn(Function(x As ChildModel) x.ParentID)
    ...
    private m_FK_Parent As HeaderModel.PK;
    Public ReadOnly Property FK_Parent As HeaderModel.PK
        Get
            If m_FK_Parent Is Nothing Then
                m_FK_Parent = New HeaderModel.PK(ParentID)
            End If
            Return m_FK_Parent
        End Get
    End Property
...
Public Class HeaderModel
    ...
    Protected Shared ReadOnly _ID As Mounter(Of _Int32) = RegisterColumn(Function(x As HeaderModel) x.ID)
...
Public Class SimpleModelBase(Of T As {ChildModel, New})
    ...
    Shared Sub New()
        RegisterChildModel(Function(x As SimpleModelBase(Of T)) x.Child, Function(x As T) x.FK_Parent)
    End Sub
