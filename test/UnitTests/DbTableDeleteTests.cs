...
";
        ...
        public void DbTable_Delete_from_temp_table()
        {
            using (var db = new Db(SqlVersion.Sql11))
            {
                ...
                var command = db.ProductCategories.MockDelete(0, tempTable, (s, _) => s.Join(_));
                var expectedSql =
...
";
        ...
        public void DbTable_Delete_from_query()
        {
            using (var db = new Db(SqlVersion.Sql11))
            {
                ...
                var command = db.ProductCategories.MockDelete(0, query, (s, _) => s.Join(_));
                var expectedSql =
@"DELETE [ProductCategory]
FROM
...
";
        ...
        public void DbTable_Delete_scalar()
        {
            using (var db = new Db(SqlVersion.Sql11))
            {
                ...
                var command = db.ProductCategories.MockDelete(false, dataSet, 0, (s, _) => s.Join(_));
                var expectedSql =
@"DECLARE @p1 INT = 0;
...
";
        ...
        public void DbTable_Delete_from_DataSet()
        {
            using (var db = new Db(SqlVersion.Sql11))
            {
                ...
                var command = db.SalesOrderDetails.MockDelete(0, salesOrderDetails, (s, _) => s.Join(_));
                var expectedSql =
