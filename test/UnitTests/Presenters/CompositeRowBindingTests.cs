...
namespace DevZest.Data.Presenters
{
    ...
    public class CompositeRowBindingTests
    {
        ...
        public void CompositeRowBinding_XAML()
        {
            ...
            Assert.AreEqual(pane[currentRow].BindingManager.Children[0], label[currentRow]);
            Assert.AreEqual(pane[currentRow].BindingManager.Children[1], textBlock[currentRow]);
