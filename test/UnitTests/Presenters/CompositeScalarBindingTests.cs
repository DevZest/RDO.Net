...
namespace DevZest.Data.Presenters
{
    ...
    public class CompositeScalarBindingTests
    {
        ...
        public void CompositeScalarBinding_flowable()
        {
            ...
            Assert.AreEqual(pane[0].BindingDispatcher.Children[0], label[0]);
            Assert.AreEqual(pane[0].BindingDispatcher.Children[1], textBlock[0]);
            Assert.AreEqual(pane[1].BindingDispatcher.Children[0], label[1]);
            Assert.AreEqual(pane[1].BindingDispatcher.Children[1], textBlock[1]);
            ...
            Assert.AreEqual(pane[1].BindingDispatcher.Children[0], label[1]);
            Assert.AreEqual(pane[1].BindingDispatcher.Children[1], textBlock[1]);
            Assert.AreEqual(pane[2].BindingDispatcher.Children[0], label[2]);
            Assert.AreEqual(pane[2].BindingDispatcher.Children[1], textBlock[2]);
