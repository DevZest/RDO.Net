...
namespace DevZest.Data.Primitives
{
    ...
    public class ColumnConverterTests
    {
        ...
        [TestMethod]
        public void Converter_Int16_FromInt64()
        {
        ...
        [TestMethod]
        public void Converter_Int16_FromSingle()
        {
        ...
        [TestMethod]
        public void Converter_Int16_FromString()
        {
        ...
        [TestMethod]
        public void Converter_Int16_GreaterThan()
        {
        ...
        [TestMethod]
        public void Converter_Int16_GreaterThanOrEqual()
        {
        ...
        [TestMethod]
        public void Converter_Int16_LessThan()
        {
        ...
        [TestMethod]
        public void Converter_Int16_LessThanOrEqual()
        {
            var column = _Int16.Const(3) <= _Int16.Const(3);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int16_Modulo()
        {
        ...
        [TestMethod]
        public void Converter_Int16_Multiply()
        {
            var column = _Int16.Const(5) * _Int16.Const(3);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int16_Negate()
        {
        ...
        [TestMethod]
        public void Converter_Int16_NotEqual()
        {
        ...
        [TestMethod]
        public void Converter_Int16_OnesComplement()
        {
        ...
        [TestMethod]
        public void Converter_Int16_Substract()
        {
            var column = _Int16.Const(5) - _Int16.Const(3);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int32_FromInt16()
        {
        ...
        [TestMethod]
        public void Converter_Int64_Add()
        {
            var column = _Int64.Const(1) + _Int64.Const(1);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_BitwiseAnd()
        {
        ...
        [TestMethod]
        public void Converter_Int64_Divide()
        {
            var column = _Int64.Const(15) / _Int64.Const(5);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_Equal()
        {
            var column = _Int64.Const(1) == _Int64.Const(1);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_FromBoolan()
        {
            var column = (_Int64)_Boolean.True;
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_FromByte()
        {
            var column = (_Int64)_Byte.Const(1);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_FromDecimal()
        {
            var column = (_Int64)_Decimal.Const(1);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_FromInt32()
        {
            var column = (_Int64)_Int32.Const(1);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_FromSingle()
        {
            var column = (_Int64)_Single.Const(1);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_FromString()
        {
            var column = (_Int64)_String.Const("1");
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_GreaterThan()
        {
            var column = _Int64.Const(4) > _Int64.Const(3);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_GreaterThanOrEqual()
        {
            var column = _Int64.Const(3) >= _Int64.Const(3);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_LessThan()
        {
            var column = _Int64.Const(3) < _Int64.Const(4);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_LessThanOrEqual()
        {
            var column = _Int64.Const(3) <= _Int64.Const(3);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_Modulo()
        {
            var column = _Int64.Const(5) % _Int64.Const(3);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_Multiply()
        {
            var column = _Int64.Const(5) * _Int64.Const(3);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_Negate()
        {
            var column = -_Int64.Const(5);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_NotEqual()
        {
            var column = _Int64.Const(1) != _Int64.Const(2);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_OnesComplement()
        {
            var column = ~_Int64.Const(0);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Int64_Substract()
        {
            var column = _Int64.Const(5) - _Int64.Const(3);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Single_Add()
        {
        ...
        [TestMethod]
        public void Converter_Single_Divide()
        {
        ...
        [TestMethod]
        public void Converter_Single_Equal()
        {
            var column = _Single.Const(1) == _Single.Const(1);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Single_FromBoolean()
        {
        ...
        [TestMethod]
        public void Converter_Single_FromByte()
        {
        ...
        [TestMethod]
        public void Converter_Single_FromDecimal()
        {
        ...
        [TestMethod]
        public void Converter_Single_FromInt32()
        {
        ...
        [TestMethod]
        public void Converter_Single_FromInt64()
        {
        ...
        [TestMethod]
        public void Converter_Single_FromString()
        {
        ...
        [TestMethod]
        public void Converter_Single_GreaterThan()
        {
        ...
        [TestMethod]
        public void Converter_Single_GreaterThanOrEqual()
        {
        ...
        [TestMethod]
        public void Converter_Single_LessThan()
        {
        ...
        [TestMethod]
        public void Converter_Single_LessThanOrEqual()
        {
            var column = _Single.Const(3) <= _Single.Const(3);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Single_Modulo()
        {
        ...
        [TestMethod]
        public void Converter_Single_Multiply()
        {
            var column = _Single.Const(5) * _Single.Const(3);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_Single_Negate()
        {
        ...
        [TestMethod]
        public void Converter_Single_NotEqual()
        {
        ...
        [TestMethod]
        public void Converter_Single_Substract()
        {
            var column = _Single.Const(5) - _Single.Const(3);
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_String_Add()
        {
        ...
        [TestMethod]
        public void Converter_String_Equal()
        {
        ...
        [TestMethod]
        public void Converter_String_FromBoolean()
        {
        ...
        [TestMethod]
        public void Converter_String_FromByte()
        {
        ...
        [TestMethod]
        public void Converter_String_FromChar()
        {
        ...
        [TestMethod]
        public void Converter_String_FromDateTime()
        {
        ...
        [TestMethod]
        public void Converter_String_FromDecimal()
        {
        ...
        [TestMethod]
        public void Converter_String_FromDouble()
        {
        ...
        [TestMethod]
        public void Converter_String_FromGuid()
        {
        ...
        [TestMethod]
        public void Converter_String_FromInt16()
        {
        ...
        [TestMethod]
        public void Converter_String_FromInt32()
        {
        ...
        [TestMethod]
        public void Converter_String_FromInt64()
        {
        ...
        [TestMethod]
        public void Converter_String_FromSingle()
        {
        ...
        [TestMethod]
        public void Converter_String_GreaterThan()
        {
        ...
        [TestMethod]
        public void Converter_String_GreaterThanOrEqual()
        {
            var column = _String.Const("a") >= _String.Const("a");
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_String_LessThan()
        {
            var column = _String.Const("a") < _String.Const("b");
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_String_LessThanOrEqual()
        {
            var column = _String.Const("a") <= _String.Const("a");
            var json = column.ToJson(true);
        ...
        [TestMethod]
        public void Converter_String_NotEqual()
        {
            var column = _String.Const("a") != _String.Const("b");
            var json = column.ToJson(true);
