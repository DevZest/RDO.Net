...
namespace DevZest.Data.Windows.Primitives
{
    ...
    public class IScrollableTests
    {
        ...
        public void IScrollable_get_extent_and_position()
        {
            ...
            Assert.AreEqual(0, scrollable.GetPositionX(0, GridPointPlacement.NextTrack));
            Assert.AreEqual(100, scrollable.GetPositionX(1, GridPointPlacement.PreviousTrack));
            Assert.AreEqual(150, scrollable.GetPositionX(2, GridPointPlacement.PreviousTrack));
            Assert.AreEqual(300, scrollable.GetPositionX(3, GridPointPlacement.PreviousTrack));
            Assert.AreEqual(450, scrollable.GetPositionX(4, GridPointPlacement.PreviousTrack));
            Assert.AreEqual(600, scrollable.GetPositionX(5, GridPointPlacement.PreviousTrack));
            Assert.AreEqual(700, scrollable.GetPositionX(6, GridPointPlacement.PreviousTrack));
            ...
            Assert.AreEqual(0, scrollable.GetPositionY(0, GridPointPlacement.NextTrack));
            Assert.AreEqual(50, scrollable.GetPositionY(1, GridPointPlacement.PreviousTrack));
            Assert.AreEqual(100, scrollable.GetPositionY(2, GridPointPlacement.PreviousTrack));
            Assert.AreEqual(150, scrollable.GetPositionY(3, GridPointPlacement.PreviousTrack));
            Assert.AreEqual(200, scrollable.GetPositionY(4, GridPointPlacement.PreviousTrack));
            Assert.AreEqual(250, scrollable.GetPositionY(5, GridPointPlacement.PreviousTrack));
        }
    }
}
